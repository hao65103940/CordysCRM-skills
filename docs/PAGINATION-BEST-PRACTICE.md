...
> **权威文档：** [`references/api.md`](../references/api.md#8-全量查询分页循环)

---

## 📚 官方文档位置

**此实战经验的权威版本已收录到：** `references/api.md` 第 8 节 "全量查询（分页循环）"

本文档保留完整实战案例、详细脚本和背景说明，适合深入阅读。  
**快速查阅标准流程请查看：** [`api.md#8-全量查询分页循环`](../references/api.md#8-全量查询分页循环)
